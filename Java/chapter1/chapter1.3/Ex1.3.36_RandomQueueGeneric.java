...
public class RandomQueueGeneric<Item> implements Iterable<Item> {

    private Item[] a;
    private int N;

    // 构造函数
    public RandomQueueGeneric(int max) {
    ...
    public static void main(String[] args) {
        ...
        RandomQueueGeneric<Card> r = new RandomQueueGeneric<Card>(60);
