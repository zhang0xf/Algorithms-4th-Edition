...
public class PriorityQueueByThreeLink<Key extends Comparable<Key>> {
    ...
    public PriorityQueueByThreeLink() {
        first = null;
        last = null;
    ...
    public static void main(String[] args) {
        PriorityQueueByThreeLink<Integer> pq
                = new PriorityQueueByThreeLink<Integer>();
