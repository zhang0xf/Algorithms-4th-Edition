...
public class MaxAndMinPriorityQueue<Key extends Comparable<Key>> {
    ...
    public MaxAndMinPriorityQueue(int max) {
    ...
    public static void main(String[] args) {
        ...
        MaxAndMinPriorityQueue<Transaction> pq
                = new MaxAndMinPriorityQueue<Transaction>(M);
