...
public class Ex31_RandomConnection {
    ...
    public static void main(String[] args) {
        // Ex31_RandomConnection.drawPointTest();
        // Ex31_RandomConnection.drawCircleTest();

        int n = Integer.parseInt(args[0]);
        double p = Double.parseDouble(args[1]);

        // Ex31_RandomConnection.drawMultPointTest(n);
