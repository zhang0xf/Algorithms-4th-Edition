...
public class Ex03_3_PQByUnOrderArray<Key extends Comparable<Key>/*, Value*/> {
    ...
    // 构造函数
    public Ex03_3_PQByUnOrderArray() {
        a = (Key[]) new Comparable[1];  // key 与 value 的区别！
        // b = (Value[]) new Object[1];
    }

    public Ex03_3_PQByUnOrderArray(int max) {
    ...
    public static void main(String[] args) {
        ...
        Ex03_3_PQByUnOrderArray<Transaction> pq
                = new Ex03_3_PQByUnOrderArray<Transaction>(M + 1);
