...
public class Ex19_MaxPoiorityQueue<Key extends Comparable<Key>> {

    private Key[] pq;
    private int N = 0;

    public Ex19_MaxPoiorityQueue(int max) {
    ...
    public static void main(String[] args) {
        ...
        Ex19_MaxPoiorityQueue<Transaction> pq
                = new Ex19_MaxPoiorityQueue<Transaction>(M + 1);
