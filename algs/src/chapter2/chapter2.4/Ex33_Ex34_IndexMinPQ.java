...
public class Ex33_Ex34_IndexMinPQ<Key extends Comparable<Key>> {
    ...
    public Ex33_Ex34_IndexMinPQ(int max) {
    ...
    public static void main(String[] args) {
        ...
        Ex33_Ex34_IndexMinPQ<Double> Impq = new Ex33_Ex34_IndexMinPQ<Double>(N);
        Impq.insert(4, 18.0);
        Impq.insert(3, 14.0);
        Impq.insert(5, 7.0);
        Impq.insert(6, 25.0);
