...
public class Ex03_MySequentialSearchST<Key extends Comparable<Key>, Value> {    //“有序”需要Comparable类型的Key
    ...
    public Ex03_MySequentialSearchST() {
    ...
    public static void main(String[] args) {
        ...
        Ex03_MySequentialSearchST<String, Integer> st
                = new Ex03_MySequentialSearchST<String, Integer>();
