...
public class Ex07_MyBST_AddInterface<Key extends Comparable<Key>, Value> {
    ...
    public static void main(String[] args) {
        ...
        Ex07_MyBST_AddInterface<String, Integer> st
                = new Ex07_MyBST_AddInterface<String, Integer>();
