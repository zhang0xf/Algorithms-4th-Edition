...
public class Ex39___Ex41_RedBlackBST<Key extends Comparable<Key>, Value> {
    ...
    public static void main(String[] args) {
        ...
        Ex39___Ex41_RedBlackBST<String, Integer> st
                = new Ex39___Ex41_RedBlackBST<String, Integer>();
