...
public class Ex02_SeparateChainingHashST<Key extends Comparable<Key>, Value> {

    //  private int N;  // 键值对数量
    private int M;  // 散列表大小
    private SequentialSearchST<Key, Value>[] st;    // 数组的对象是链表

    public Ex02_SeparateChainingHashST() {
        this(997);  // 使用997条链表
    }

    public Ex02_SeparateChainingHashST(int M) {
        this.M = M;
    ...
    public static void main(String[] args) {
        Ex02_SeparateChainingHashST<String, Integer> st
                = new Ex02_SeparateChainingHashST<String, Integer>();
