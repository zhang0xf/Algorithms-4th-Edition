...
public class Ex17_Ex19_LinearProbeHashST<Key extends Comparable<Key>, Value> {
    ...
    public Ex17_Ex19_LinearProbeHashST(int M) {
        this.M = M;
    ...
    private void resize(int cap) {
        Ex17_Ex19_LinearProbeHashST<Key, Value> st = new Ex17_Ex19_LinearProbeHashST<Key, Value>(
                cap);
        for (int i = 0; i < M; i++) {
            if (keys[i] != null) {
    ...
    public static void main(String[] args) {
        Ex17_Ex19_LinearProbeHashST<String, Integer> st
                = new Ex17_Ex19_LinearProbeHashST<String, Integer>(60);
